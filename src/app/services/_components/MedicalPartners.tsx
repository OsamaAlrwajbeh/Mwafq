  ...
  const partners = [
    {
      ...
      description: "Streamlined and hassle-free Iqama medical examinations for your employees"
    },
    {
      image: health2,
      name: "Al-Shablan Medical Complex",
      description: "Quick, reliable, and fully compliant Baladiya examinations for your employees"
    },
    {
      image: health3,
      name: "Al Salam Medical Complex - Unaizah",
      description: "Fast and accurate pre-employment medical tests to ensure your candidates are ready for work"
    },
    {
      image: health1,
  ...
  return (
    <section className="container_main">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-4xl font-bold text-custom-darkBlue">Medical Partners</h1>
        </div>
